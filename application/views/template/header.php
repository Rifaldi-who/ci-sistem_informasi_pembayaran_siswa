    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url('admin') ?>" class="logo">
                ...
                <span class="logo-lg"><b>MA </b>AL-IDRUS</span>
            </a>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?= base_url('assets') ?>/dist/img/idrus.png" class="img-circle" alt="User Image">
                    </div>
                    <div class="pull-left info">
                    <?php if (isset($your_array) && isset($your_array['your_offset'])) : ?>
    <!-- Your code to use $your_array['your_offset'] goes here -->
<?php endif; ?>
